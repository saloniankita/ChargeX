    ...
    MediaBoxes.prototype.init = function (container, options) {
        ...
        */
        ...
        function addSocialButtons(item) {
            var FullURL = ""; // the url of your page
            var URLWithoutHash = "" // the url of your page without the hashtag
